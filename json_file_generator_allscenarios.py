...
archivo_base = 'OptModel_RDMv1.7.json'
...
for reemplazo_demanda in reemplazos_demanda:
    for reemplazo_oferta in reemplazos_oferta:
        ...
        data_modificada = json.dumps(data).replace("ANCTEND_CLIMIN_ECOACE", reemplazo_demanda).replace("1A, 0.95", reemplazo_oferta)
...
num_archivos_por_carpeta = 27
num_carpetas = 36
directorio_base = 'copias_generadas_1'
